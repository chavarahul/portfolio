...
const Contact = () => {
  return (
    <>
      ...
      <section className="min-h-[30vh] w-screen  flex-center bg-[#2a2f3f0d] p-10 pt-16">
        <div className="w-[80%] min-h-[50vh] relative ">
          <div className="w-full h-[25em] flex-bet flex-col">
            <div className="w-full h-[80%] flex">
              <div className="w-[40%] h-full relative">
                ...
                <div className={`relative w-full h-[60%] leading-10 text-lg ${poppin.className}`} >
                  <p className="mt-5">
                    I am a senior frontend developer and full stack developer.
                  </p>
                </div>
              </div>
            ...
            <div className="w-full h-[20%] flex-center relative -mt-40">
